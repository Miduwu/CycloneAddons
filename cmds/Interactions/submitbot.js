...
module.exports["data"] = {
    ...
    async code(i) {
        ...
        if(botUser?.bot == false) return i.reply({ embeds: [new EmbedBuilder().setDescription("<:cyaddons_error:1060665620468863096> | ***`El usuario no es un bot.`***").setColor(Auxiliar.Colors.red)], ephemeral: true })
